...
export NODE_ENV=production
npx parcel build src/simple/index.html --public-url './' --experimental-scope-hoisting --detailed-report --out-dir $OUTDIR/simple --out-file $OUTDIR/simple/index-min.html
