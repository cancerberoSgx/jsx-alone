...
},{"./createElement":"Hbm/","./elementImpl":"KmFW"}],"C/Rc":[function(require,module,exports) {
"use strict";
function __export(m) {
    for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];
}
...
function getJSXAlone() {
  //@ts-ignore
  var name = typeof JSXAloneImplName__ === 'undefined' ? undefined : JSXAloneImplName__;
  debugger;
...
},{"jsx-alone-dom":"jxZo","jsx-alone-string":"o3Jh"}],"IAey":[function(require,module,exports) {
"use strict";
  ...
  App.prototype.render = function () {
    ...
    return JSXAlone.createElement("div", null, JSXAlone.createElement("h1", null, "Lots of people to print"), JSXAlone.createElement(jsx_alone_core_1.If, {
      ...
      return JSXAlone.createElement("div", null, JSXAlone.createElement("p", null, "People count: ", JSXAlone.createElement("input", {
        ...
        onClick: function onClick(e) {// const peopleCount = document.querySelector<HTMLInputElement>('#peopleCount')!.valueAsNumber
...
var jsx_alone_dom_1 = require("jsx-alone-dom"); //@ts-ignore
