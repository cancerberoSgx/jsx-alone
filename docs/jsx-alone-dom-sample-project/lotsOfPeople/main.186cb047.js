...
},{"./createElement":"S0OW","./elementImpl":"gNvY","./misc":"F7e8"}],"BHXf":[function(require,module,exports) {
"use strict";
...
exports.printMs = printMs;
},{}],"BpPo":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
function randomIntBetween(a, b) {
    return Math.floor(Math.random() * b) + a;
...
},{}],"/yeL":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.firstNames = [
    "William",
...
},{}],"vUU2":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.lastNames = [
    "Smith",
...
},{}],"xIWX":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../util":"BpPo","./firstNames":"/yeL","./lastNames":"vUU2"}],"Oe2E":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const util_1 = require("./util");
exports.numbers = {
...
},{"./util":"BpPo"}],"h6W8":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./names":"xIWX","./numbers":"Oe2E"}],"SW/q":[function(require,module,exports) {
"use strict";
...
},{"./util":"BHXf","misc-utils-of-mine-random-data":"h6W8"}],"/NHn":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  App.prototype.render = function () {
    return jsx_alone_dom_2.JSXAlone.createElement("div", {
      id: "lotsOfPeopleRoot"
    }, jsx_alone_dom_2.JSXAlone.createElement("h1", null, "Lots of people to print"), jsx_alone_dom_2.JSXAlone.createElement("p", null, "People count: ", jsx_alone_dom_2.JSXAlone.createElement("input", {
      id: "peopleCount",
...
},{"jsx-alone-dom":"MNUJ"}],"wdqJ":[function(require,module,exports) {
"use strict";
...
function renderApp(config) {
  ...
  window.onload = function () {
    ...
    document.getElementById('timings_onload').innerHTML = util_1.printMs(onloadT);
    document.getElementById('timings_buildModel').innerHTML = util_1.printMs(buildModelT);
    document.getElementById('timings_JSXAloneCreateElement').innerHTML = util_1.printMs(JSXAloneCreateElementT);
    document.getElementById('timings_JSXAloneRender').innerHTML = util_1.printMs(JSXAloneRenderT);
  };
  ...
  var app = jsx_alone_dom_1.JSXAlone.createElement(App_1.App, __assign({}, model, config));
  ...
  var root = document.getElementById('lotsOfPeopleRoot');
...
renderApp(model_1.MODEL_CONFIG);
},{"jsx-alone-dom":"MNUJ","./model":"SW/q","./App":"/NHn","./util":"BHXf"}]},{},["wdqJ"], null)
