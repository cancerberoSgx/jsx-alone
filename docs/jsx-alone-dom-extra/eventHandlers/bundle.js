...
},{"./":13,"./StatefulComponent":10}],10:[function(require,module,exports){
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var Button = (function (_super) {
    ...
    Button.prototype.render = function () {
        return __1.JSXAlone.createElement("button", { onClick: this.props.onClick }, this.props.children);
    };
    return Button;
}(__1.ElementClass));
...
var App = (function (_super) {
    ...
    App.prototype.render = function () {
        var _this = this;
        var foo = 'hello';
        return (__1.JSXAlone.createElement("div", null,
            __1.JSXAlone.createElement(Container, null,
                __1.JSXAlone.createElement("p", null,
                    "just some tests for function attributes context - most doesn't work because don't use extras, just core dom implementation",
                    __1.JSXAlone.createElement("button", { onClick: function (e) {
                            console.log(_this, _this.props.name, _this.foo(), foo);
                        } }, "Render!"),
                    __1.JSXAlone.createElement(Container, null,
                        __1.JSXAlone.createElement("button", { onClick: function (e) {
                                console.log(_this, _this.props.name, _this.foo(), foo);
...
var bar = 'bar';
var app = (__1.JSXAlone.createElement("div", null,
    __1.JSXAlone.createElement("button", { onClick: function (e) {
    ...
    __1.JSXAlone.createElement(App, { name: "John Doe", tasks: ['Wash dishes', 'Go outside', 'Play soccer'] })));
var el = __1.JSXAlone.render(app);
document.body.appendChild(el);

},{"../..":13,"jsx-alone-core":5}],12:[function(require,module,exports){
var __assign = (this && this.__assign) || function () {
    __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
...
},{"jsx-alone-core":5,"jsx-alone-dom":18}],13:[function(require,module,exports){
function __export(m) {
    for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];
}
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./DestructiveDomRenderComponent":9,"./StatefulComponent":10,"./createElement":12}],14:[function(require,module,exports){
var __assign = (this && this.__assign) || function () {
    __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
...
},{".":18,"./event":17,"./refs":20,"jsx-alone-core":5}],15:[function(require,module,exports){
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
},{"./refs":20,"./util":22,"jsx-alone-core":5}],17:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./mark":19,"jsx-alone-core":5}],18:[function(require,module,exports){
function __export(m) {
    for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];
}
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./createElement":14,"./elementClass":15,"./elementImpl":16,"./event":17,"./updatablePropsComponent":21,"./util":22}],19:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", { value: true });
var jsx_alone_core_1 = require("jsx-alone-core");
