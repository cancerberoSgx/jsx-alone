...
var MNode = (function (_super) {
    ...
    MNode.prototype.replaceWith = function () {
        ...
        children.splice.apply(children, __spreadArrays([children.indexOf(this), 1], nodes.map(function (n) { return typeof n === 'string' ? _this.ownerDocument.createTextNode(n) : n; })));
    };
