...
import { evaluate, escapeHtml, query } from '../../util/util';
...
export class ImplExplorer extends Component<P> {
  ...
  render() {
    try {
      this.stringOutput = evaluate(this.props.editor.code, 'string')
    ...
    try {
      this.domOutput = evaluate(this.props.editor.code, 'dom')
